...
class PartnersFragment(private val partners: List<Partner>): Fragment() {
    override fun onCreateView(
        ...
        val recyclerView = view.findViewById<RecyclerView>(R.id.rvPartners)
        recyclerView.layoutManager = LinearLayoutManager(context)
        recyclerView.adapter = PartnersAdapter(partners)
